...
**Location:** `src/features/events/hooks/useEvent.ts`
...
**Location:** `src/features/events/components/Events/Events.tsx`

**Complete file contents:**

```tsx
// src/features/events/components/Events/Events.tsx
...
- [ ] `src/features/events/hooks/useEvent.ts` wraps useSupabaseEvents
- [ ] `src/features/events/components/Events/Events.tsx` calls `useEvents()` at top of function
