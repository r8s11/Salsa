  ...
  return (
    <div className="admin-submission-detail-page">
      <header className="admin-submission-detail-page__header">
        <button type="button" onClick={() => navigate("/admin/submissions")} className="admin-btn">
      ...
      <div className="admin-submission-detail-page__body">
        ...
        <section className="admin-card">
          ...
          {rawStyles.length > 0 ? (
            ...
            <p>No dance styles were supplied</p>
          )}
        ...
        {updateError && (
          <p role="alert">
            {updateError instanceof Error ? updateError.message : "Rejection failed"}
          </p>
        )}
