...
### 9. [src/features/events/hooks/useEvent.ts](../../src/features/events/hooks/useEvent.ts)
...
### 11. [src/features/calendar/components/Calendar.tsx](../../src/features/calendar/components/Calendar.tsx) (no logic change)
...
When Supabase is populated, change [src/features/events/hooks/useEvent.ts](../../src/features/events/hooks/useEvent.ts) back to call `useSupabaseEvents`. Optionally:
