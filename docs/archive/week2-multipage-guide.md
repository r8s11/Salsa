...
Replace your entire `src/app/App.tsx` with:
...
Add these styles to your `src/styles/index.css` (or main stylesheet):
...
Add to your `src/styles/index.css`:
...
Update the Routes in `src/app/App.tsx`:
