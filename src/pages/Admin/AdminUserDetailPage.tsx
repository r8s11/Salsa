...
import { useUserAuditLog } from "../../features/admin/hooks/useUserAuditLog";
...
import { useResendOrganizerInvitation } from "../../features/admin/hooks/useResendOrganizerInvitation";
...
export default function AdminUserDetailPage() {
  ...
  const {
    ...
    isSending: isResendingInvitation,
    sentTo: invitationSentTo,
    ...
    <div className="admin-user-detail-page">
      ...
      <div className="admin-user-detail-page__layout">
        ...
        <aside className="admin-user-detail-page__side-rail" aria-label="Account operations">
          ...
          {/* An organizer whose email is still unconfirmed has never accepted
              their invitation — the only state where a resend is meaningful. */}
          {user.role === "organizer" && user.user_id && !user.email_confirmed_at && (
            <section className="admin-card admin-user-detail-page__invitation">
              ...
              {invitationSentTo && <p role="status">Invitation resent to {invitationSentTo}.</p>}
              {resendInvitationError && <p role="alert">{resendInvitationError}</p>}
            </section>
          )}
