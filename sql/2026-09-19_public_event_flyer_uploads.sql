-- Manually run this file in the Supabase SQL Editor after review and approval.
-- It reconciles the event-flyers bucket and policies without changing event data.
